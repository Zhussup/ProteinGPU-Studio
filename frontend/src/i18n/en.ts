...
export const en: Dict = {
  ...
  // Sensitivity map / "wind rose" (dum.md §5)
  'run.map': 'Map (rose)',
  'run.mapTitle':
    'sensitivity map: range positions × 19 substitutions — a response vector per position; ' +
    'the most expensive job (19 folds per position)',
  'run.stage.map': 'map',
  'run.mapRange': 'Map positions',
  ...
  'map.metric.vmed': 'median local RMSD',
  'map.paint': 'Paint 3D',
  'map.paintTitle': 'color the WT structure by the chosen scalar\'s percentiles',
  'map.clearPaint': 'clear paint',
  'map.painted': '3D painted: {metric} (within-protein percentiles)',
  'map.csv': 'CSV (dataset)',
  'map.json': 'JSON',
  'map.heatmap': 'Heat map: positions × compass directions (color = |ΔpLDDT| percentile)',
  'map.heatTip': '{m} · |ΔpLDDT| pctl {pctl} · RMSD {rmsd} Å',
  'map.heatLegend': 'hotter = more fragile',
  'map.h.pos': 'position',
  'map.h.rose': 'rose',
  'map.h.quadrant': 'quadrant',
  'map.h.max': 'max local RMSD, Å',
  'map.h.med': 'median local RMSD, Å',
  'map.h.pctl': 'percentile',
  'map.roseTitle': 'rose of position {m}',
  'map.detailTitle': 'Rose of position {m}',
  'map.detailMax': 'max local RMSD {v} Å',
  'map.detailMed': 'median {v} Å',
  'map.detailSharp': 'sharpness {v}',
  'map.lenChannel': 'petal length — |ΔpLDDT| percentile within the protein',
  'map.colorChannel': 'color — local RMSD percentile within the position',
  'map.petalTip': '{m} · |ΔpLDDT| pctl {pctl} · RMSD {rmsd} Å',
  'map.quad.hedgehog': 'hedgehog',
  'map.quad.needle': 'needle',
  'map.quad.disk': 'disk',
  'map.quad.clover': 'clover',
  'map.quad.hedgehogTitle': 'every substitution hurts',
  'map.quad.needleTitle': 'one chemical direction hurts',
  'map.quad.diskTitle': 'tolerant position',
  'map.quad.cloverTitle': 'strong but ragged — several bright petals',
  'map.note':
